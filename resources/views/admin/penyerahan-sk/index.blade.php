...
@section('admin-content')
    <div id="printableArea">
        <div class="position-relative pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 mb-0 text-gray-800 text-center">Rekapitulasi Penyerahan SK Perizinan Layanan Khusus (LAJIK)</h1>
            <div class="position-absolute top-50 end-0 translate-middle-y me-3 no-print">
                ...
                <a href="{{ route('admin.penyerahan-sk.export') }}" class="btn btn-success btn-sm">
                        ...
                        <tbody>
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->personalData->izinPengajuan->first()->jenisIzin->nama_izin ?? 'N/A' }}
                                    </td>
                                    ...
                                    <td class="text-center">
                                        @if ($item->foto_penyerahan)
                                            <a href="{{ asset('storage/' . $item->foto_penyerahan) }}" target="_blank"
