        ...
        <div class="container">
            ...
            @if (session('success'))
                <div class="alert alert-success border-0 shadow-lg rounded-4 mb-4 position-relative overflow-hidden"
                        ...
                        <div class="flex-grow-1">
                            ...
                            @if (session('error'))
                                <div class="alert alert-danger border-0 shadow-lg rounded-4 mb-4 position-relative overflow-hidden"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <svg class="w-6 h-6 text-danger animate-bounce" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                    ...
                                    <div class="position-absolute top-0 start-0 w-100 h-100 opacity-25"
                                        style="background: linear-gradient(45deg, transparent 30%, rgba(220, 53, 69, 0.1) 50%, transparent 70%); animation: shimmer 2s ease-in-out infinite alternate;">
                                    </div>
                                </div>
                            @endif
                    ...
                    <div class="position-absolute top-0 start-0 w-100 h-100 opacity-25"
                        style="background: linear-gradient(45deg, transparent 30%, rgba(40, 167, 69, 0.1) 50%, transparent 70%); animation: shimmer 2s ease-in-out infinite alternate;">
                    </div>
                </div>
            @endif
                ...
                <div class="alert alert-danger border-0 shadow-lg rounded-4 mb-4 position-relative overflow-hidden"
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="text-muted">Mohon periksa kembali form Anda dan pastikan semua field yang wajib
                                diisi telah terisi dengan benar.</small>
                        </div>
                        <button type="button" class="btn-close position-absolute top-50 end-0 translate-middle-y me-3"
                            data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" class="form-control" value="{{ old('nama') }}"
                                placeholder="Nama harus sesuai dengan KTP" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="alamat_jalan" class="form-control" value="{{ old('alamat_jalan') }}"
                                placeholder="Alamat harus sesuai dengan KTP" required>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Kabupaten/Kota <span
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Kelurahan/Desa <span
                                    class="text-danger">*</span></label>
